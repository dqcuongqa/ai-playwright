...
test.describe('Create User API - Missing Email', () => {
    let token = '';
    ...
    test('Should fail to create a user when email is missing', async ({ request, baseURL }) => {
        ...
        console.log('Missing Email Error Response:', body);
