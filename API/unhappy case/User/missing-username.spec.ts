...
test.describe('Create User API - Missing Username', () => {
    let token = '';
    ...
    test('Should fail to create a user when username is missing', async ({ request, baseURL }) => {
        ...
        console.log('Missing Username Error Response:', body);
