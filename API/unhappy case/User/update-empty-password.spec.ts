...
test.describe('Update User - Empty Password', () => {
    let token = '';
    let userId = '';
    ...
    test.beforeAll(async ({ request, baseURL }) => {
        ...
        console.log(`Selected user ID for empty password test: ${userId}`);
    });

    test('Should fail to update user with empty password', async ({ request, baseURL }) => {
        ...
        console.log('Empty Password Error Response:', JSON.stringify(body, null, 2));
