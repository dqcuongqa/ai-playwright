...
test.describe('Create Category API - Empty Name', () => {
    let token = '';
    let userId = '';
    ...
    test('Should fail to create category with empty name', async ({ request, baseURL }) => {
        ...
        console.log(`Create Category Empty Name Response Status: ${response.status()}`);
        console.log('Create Category Empty Name Response Body:', JSON.stringify(body, null, 2));
